...
/* harmony import */ var _modules_promo__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/promo */ "./js/modules/promo.js");
...
Object(_modules_promo__WEBPACK_IMPORTED_MODULE_3__["promo"])();
...
var SECONDARY_ACTIVE_CLASS = 'promo__secondary--active';
var promo = function promo() {
  var promoInner = document.querySelector('.promo__inner');
  var promoSecondary = promoInner && promoInner.querySelector('.promo__secondary');

  if (!promoSecondary) {
    return;
  }

  promoInner.addEventListener('click', function () {
